...
public class Order 
{
	...
	private ArrayList<cpsc4620.Pizza> PizzaList;
	private ArrayList<cpsc4620.Discount> DiscountList;
	...
	public Order(int orderID, int custID, String orderType, String date, double custPrice, double busPrice, int iscomplete) {
		...
		PizzaList = new ArrayList<cpsc4620.Pizza>();
		DiscountList = new ArrayList<cpsc4620.Discount>();
	}

	public Order() {
	}

	public void addPizza(cpsc4620.Pizza p)
	{
		PizzaList.add(p);
	}
	...
	public void addDiscount(cpsc4620.Discount d)
	{
		DiscountList.add(d);
		if(d.isPercent())
		{
	...
	public ArrayList<cpsc4620.Pizza> getPizzaList() {
		return PizzaList;
	}


	public ArrayList<cpsc4620.Discount> getDiscountList() {
		return DiscountList;
	}
	...
	public void setPizzaList(ArrayList<cpsc4620.Pizza> pizzaList) {
		PizzaList = pizzaList;
	}


	public void setDiscountList(ArrayList<cpsc4620.Discount> discountList) {
